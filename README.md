...
* Set `website_name` and `email_password_reset` in `ignition_application/config/ignition_config.php`
* Set `base_url` and `encryption_key` in `ignition_application/config/config.php`
